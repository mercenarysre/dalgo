...
// Time Complexity: O(n), case of nested loop where the outer loop iterates n times,
// where n is the length of the array however the inner loop runs for counts[n]
// which is different everytime and cannot be factored into the time complexity, thus O(n)
